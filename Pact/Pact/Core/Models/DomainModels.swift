...
enum AppIdentity {
    static let name = "Round"
    static var supportEmail: String { configured("ROUND_SUPPORT_EMAIL", fallback: "support@round.invalid") }
    static var inviteHost: String { configured("ROUND_INVITE_HOST", fallback: "round.invalid") }
    static var privacyURL: URL? { URL(string: configured("ROUND_PRIVACY_URL", fallback: "")) }
    static var termsURL: URL? { URL(string: configured("ROUND_TERMS_URL", fallback: "")) }
...
struct RoundUser: Identifiable, Codable, Hashable, Sendable {
    var id: UUID
...
struct RoundGroup: Identifiable, Codable, Hashable, Sendable {
    var id: UUID
    var name: String
    var emoji: String
    var ownerID: UUID
...
struct RoundChallenge: Identifiable, Codable, Hashable, Sendable {
    var id: UUID
    var groupID: UUID
    var proposalID: UUID?
    var title: String
...
struct UserNotificationSettings: Codable, Hashable, Sendable {
    ...
    static func defaults(userID: UUID, groups: [RoundGroup]) -> UserNotificationSettings {
        .init(
...
struct PreviousRoundSummary: Identifiable, Codable, Hashable, Sendable {
    var id: UUID
    var title: String
...
struct MemberRoundResult: Identifiable, Codable, Hashable, Sendable {
    var id: UUID { user.id }
    var user: RoundUser
...
struct RoundResult: Identifiable, Codable, Hashable, Sendable {
    var id: UUID
    var groupID: UUID
    var challengeID: UUID
    var title: String
...
struct DemoSnapshot: Codable, Sendable {
    ...
    var previousRound: PreviousRoundSummary?
    var roundResults: [RoundResult]? = nil
