...
struct RoundApp: App {
    ...
    init() {
        ...
        RoundMetricSubscriber.shared.start()
    ...
    private static func makeContainer() -> ModelContainer {
        ...
        do {
            return try ModelContainer(
                for: schema,
                migrationPlan: RoundSwiftDataMigrationPlan.self,
            ...
            do {
                ...
                fatalError("Round could not create its local store: \(error.localizedDescription)")
            }
        }
    }
}
