-- Accept Swift UUID.uuidString (uppercase) storage paths that already uploaded.
-- Match path shape and storage.objects case-insensitively; persist the canonical object name.
