# Cahoots MVP implementation plan
...
- Project model: Xcode file-system-synchronised groups, so feature files beneath `Cahoots/` are discovered automatically.
...
1. Record the required Mobbin design review and establish Cahoots's original design tokens.
