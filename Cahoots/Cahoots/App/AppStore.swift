...
final class AppStore {
    ...
    private func validateChallengeDraft(_ draft: ProposalDraft, snapshot: DemoSnapshot, group: CahootsGroup) -> Bool {
    ...
    func handleURL(_ url: URL) {
        guard let route = AppRoute.parse(url) else {
            errorBanner = String(localized: "That Cahoots invitation link is not valid.")
