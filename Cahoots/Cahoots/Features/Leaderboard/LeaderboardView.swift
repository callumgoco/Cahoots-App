...
struct CrewStandingsSection: View {
    ...
    var body: some View {
        VStack(spacing: AppSpacing.medium) {
            CahootsSectionHeader(title: "Standings")
...
struct PodiumCard: View {
    ...
    var body: some View {
        VStack(spacing: AppSpacing.small) {
            ...
            Text("points")
                .font(.caption2)
                .foregroundStyle(rank == 1 ? AppColors.onInk.opacity(0.7) : AppColors.secondaryInk)
        }
        ...
        .foregroundStyle(rank == 1 ? AppColors.onInk : AppColors.ink)
